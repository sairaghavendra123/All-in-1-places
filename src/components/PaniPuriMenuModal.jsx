...
export const PANI_PURI_MENU_SECTIONS = [
  {
    id: 'panipuri',
    icon: '🌊',
    title: 'Pani Puri Specials',
    subtitle: 'crisp puris, tangy water',
    items: [
      'Classic Pani Puri',
      'Masala Pani Puri',
      'Spicy Pani Puri',
      'Sweet & Spicy Pani Puri',
      'Mint Pani Puri',
      'Ragda Pani Puri'
    ]
  },
  ...
  },
  {
    id: 'street',
    icon: '🌽',
    title: 'Street Chaat Specials',
    subtitle: 'the roadside classics',
    items: [
      'Cheese Corn Chaat',
      'Sweet Corn Chaat',
      'Sprouts Chaat',
...
export default function PaniPuriMenuModal({ isOpen, onClose }) {
  const [activeTab, setActiveTab] = useState('panipuri');
  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-y-auto bg-black/85 backdrop-blur-md">
        ...
        {/* Vintage Pani Puri & Chaat Menu Card Container */}
        <motion.div
        ...
        >
          ...
          <div className="relative border-2 border-[#C08A34]/40 rounded-xl p-5 sm:p-8 bg-[#F7EFDB] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-100/30 via-transparent to-transparent">
            ...
            <div className="text-center mb-6">
              ...
              {/* Animated Steam / Tangy Wave SVG Graphic */}
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mb-6 pb-4 border-b border-[#2A1810]/15">
              {PANI_PURI_MENU_SECTIONS.map((sec) => (
                <button
                  key={sec.id}
            ...
            <div className="max-h-[50vh] overflow-y-auto pr-1 custom-scrollbar">
              {PANI_PURI_MENU_SECTIONS.filter(s => s.id === activeTab).map((sec) => (
            ...
            <div className="mt-6 pt-4 border-t border-[#2A1810]/15 text-center">
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest text-[#5A4632]/80 block mb-4">
                One Corner · Every Bite · Always Tangy
              </span>
